...
tags:
  ...
  - "句法"
  - "选题"
description: "顶会分析论文常用一套「句法」把研究对象、机制变量、证据结构与行动结论黏合成可检验、可反驳、可行动的研究主张。本文给出 18 类句法骨架，每类附一篇对应范文，并点出三类常见卡点——缺可操控的 M、无反事实构造、「必要性」未写成条件句。"
---

# 分析类论文的 18 个句法骨架

> 顶会分析论文常用一套「句法」把研究对象、机制变量、证据结构与行动结论黏合成可检验、可反驳、可行动的研究主张。本文给出 18 类句法骨架，每类附一篇对应范文，并点出三类常见卡点——缺可操控的 M、无反事实构造、「必要性」未写成条件句。
