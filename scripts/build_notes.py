...
art("essays/featured",
    "精选",
    [("drafts/featured.md", None)], "随笔",
    ["精选", "导读", "第一档价值"],
    intro="这几篇是我写得最用心、也自认为价值最高的一组文章——不按学科分堆，而是按「值得反复读」这条标准拎出来的。"
          "从科学研究的元认知，到自回归大模型的内部机制，再到研究方法论的实战心法。单独开一个栏目，方便直接取用。")

art("essays/future-ai-paradigms",
    "AI 的范式革新",
    [("drafts/future-ai-paradigms.md", None)], "随笔",
    ["AI 范式", "未来展望", "多模态", "持续学习", "AI4S"],
    intro="从目标与模态范式、训练范式两个角度，梳理 AI 正在发生的底层革新："
          "文本、视觉/物理、数据三种中心范式各自解决了什么，"
          "以及持续学习如何把模型从一次性训练的产品，变成能长期成长的系统。")
